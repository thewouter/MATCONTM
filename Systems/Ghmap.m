...
% --------------------------------------------------------------------------
function dydt = fun_eval(t,kmrgd,alpha,beta,r,s)
dydt=[kmrgd(2),;
alpha-beta*kmrgd(1)-kmrgd(2)^2+r*kmrgd(1)*kmrgd(2)+s*kmrgd(2)^3,;];
...
% --------------------------------------------------------------------------
function jac = jacobian(t,kmrgd,alpha,beta,r,s)
jac=[[0,1];[-beta+r*kmrgd(2),-2*kmrgd(2)+r*kmrgd(1)+3*s*kmrgd(2)^2]];
% --------------------------------------------------------------------------
function jacp = jacobianp(t,kmrgd,alpha,beta,r,s)
