function [xout, vout, sout, hout, fout] = cont_modded(varargin)
%
...
global contOutput;
if isempty(contOutput)
   contOutput = @(varargin) 0; 
end
global stepSizeTooSmall
stepSizeTooSmall = 0;
...
while i < npoints
    ...
    if ((i > 2) && (s.index == (i - 1)))
       printconsole('bifurcation found, exiting ...\n');
       npoints = i;
    end
    contOutput(xout,s,hout,fout,ind);
